...
for i = ROI_start:1:ROI_end
    ...
    imwrite(project_front(I),sprintf("/Users/lucasphilipp/Desktop/Research/Weber/Dinoflagellate FIB-SEM Data/Slice & View/Brandtodinium nutricula/Brandtodinium FL cell 1 chromosomes/front/projected_ROI_front%i.png",i));
end

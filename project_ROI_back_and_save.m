...
for i = ROI_start:1:ROI_end
    ...
    imwrite(project_back(I),sprintf("/Users/lucasphilipp/Desktop/Research/Weber/Dinoflagellate FIB-SEM Data/Slice & View/Ensiculifera tyrrhenica/ensiculifera tyrrhenica chromosomes/back/projected_ROI_back%i.png",i));
end

...
pitch = -2;  % Distance between turns, negative -> left handed helix, positive -> right handed helix
num_turns = 10; % Number of turns
num_points_per_turn = 20; % Number of points per turn
...
plot3(xx,yy,zz,'Color', [.6 .6 .6])
%quiver3(xyz_coordinates(:,1)-bond_vectors(:,1),xyz_coordinates(:,2)-bond_vectors(:,2),xyz_coordinates(:,3)-bond_vectors(:,3),bond_vectors(:,1),bond_vectors(:,2),bond_vectors(:,3))
set(gca,'Xticklabel',[])
set(gca,'Yticklabel',[])
set(gca,'Zticklabel',[])

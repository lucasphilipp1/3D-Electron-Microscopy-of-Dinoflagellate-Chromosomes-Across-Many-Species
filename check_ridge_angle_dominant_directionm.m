...
for i = ROI_start:1:ROI_end
    orientationJ_dom_dir = readmatrix("/Users/lucasphilipp/Desktop/Research/Weber/Dinoflagellate FIB-SEM Data/Slice & View/Symbiodinium Clade A/Cell 1/output/"+sprintf("dominant_direction_%i.csv",i-ROI_start));
    if orientationJ_dom_dir(:,3)>0.1; %require minimum coherency value of 1%
        angles_for_histogram = [angles_for_histogram; orientationJ_dom_dir(:,2)];

        Icheck = imread("/Users/lucasphilipp/Desktop/Research/Weber/Dinoflagellate FIB-SEM Data/Slice & View/Symbiodinium Clade A/Cell 1/input/"+sprintf("residual_ROI_%i.png",i));
        ...
        alpha = 270-orientationJ_dom_dir(:,2); %orientationJ: +90 is up, -90 is down, 0 is right %code below: 0 down, 90 left, 180 up, 270 right
        ...
        ax = gca;
        exportgraphics(ax,"/Users/lucasphilipp/Desktop/Research/Weber/Dinoflagellate FIB-SEM Data/Slice & View/Symbiodinium Clade A/Cell 1/check/"+sprintf('angle_check_ROI_%i.jpg',i),"Resolution",1000)
        pause(1)
        close
    end
end
